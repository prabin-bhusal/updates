        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        <div class="">
                            <form method="post" action="{{ route('admin.news.update', ['news' => $news->id]) }}" enctype="multipart/form-data" class="max-w-md mx-auto">
                                @csrf
                                @method('put')
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    <img id="preview" src="{{ asset('storage/images/' . $news->banner_image) }}" style="height:200px;" alt="your image" class="mt-3" />
                                    <span>
                                        @error('banner_image')
                                        {{ $message }}
                                        @enderror
