    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center bg-white my-3 p-5 mb-4">
            <h2 class="text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-3xl dark:text-white">
                Notices</h2>
            <a href="{{ route('admin.notices.create') }}" class="text-blue-600 hover:text-yellow-800 hover:cursor-pointer">Create New
                Notice</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900">
                            <!--need to define for the general users also  -->
                            <a href="{{ route('admin.notices.show', ['notice' => $notice->id]) }}" class="hover:underline">
