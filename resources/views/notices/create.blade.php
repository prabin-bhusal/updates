                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="mt-2">
                                        <label for="datepicker"
                                            class="block text-sm font-medium leading-6 text-gray-900">Notice date</label>
                                    ...
                                    <div class="col-span-full">
                                        <label for="cover-photo"
                                            class="block text-sm font-medium leading-6 text-gray-900">Attach file</label>
                                        <div
                                            class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                            <div class="text-center">
                                                <svg class="mx-auto h-12 w-12 text-gray-300" viewBox="0 0 24 24"
                                                ...
                                                <p class="text-xs leading-5 text-gray-600">PNG, JPG, PDF, DOCX up to 10MB
                                                </p>
                                            </div>
                                        </div>
                                    </div>
