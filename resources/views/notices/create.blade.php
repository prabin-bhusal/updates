                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <input type="text" name="title" id="title"
                                                    ...
                                                    placeholder="Call for manuscript submission 2022">
                                            </div>
                                        </div>
                                        @error('title')
                                    ...
                                    <div class="mt-2">
                                        <label for="datepicker"
                                            class="block text-sm font-medium leading-6 text-gray-900">Notice
                                            date</label>
                                        <input id="notice_date" class="border-2 border-gray-300 rounded px-3 py-2 w-56"
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                                    <label for="cover-image-upload"
                                                        ...
                                                        <input id="cover-image-upload" name="cover_image_upload"
                                    ...
                                    <div class="col-span-full">
                                        <label for="cover-photo"
                                            class="block text-sm font-medium leading-6 text-gray-900">Attach
                                            file</label>
                                        <div
                                            class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                            <div class="text-center">
                                                ...
                                                <p class="text-xs leading-5 text-gray-600">PNG, JPG, PDF, DOCX up to
                                                    10MB</p>
                                            </div>
                                        </div>
                                    </div>
