        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        <div class="">
                            <form method="post" action="{{ route('admin.download.update', ['download' => $download->id]) }}" enctype="multipart/form-data" class="max-w-md mx-auto">
                                @csrf
                                @method('put')
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    <label for="download_file" name="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Resource
                                        File</label>
                                    <input type="file" name="download_file" placeholder="Enter title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                    <span class="text-green-700">
                                        Previous: {{ $download->download_file }}
                                    </span>
