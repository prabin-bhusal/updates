            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div>
                            <div class="">
                                <form method="post" action="{{ route('download.update', ['download' => $download->id]) }}"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            placeholder="Enter title" value="{{ $download->title }}" class="form-control"
                                            value="{{ old('title') }}" />
                                    ...
                                    <div class="mb-5">
                                        <label for="download_file" name="image"
