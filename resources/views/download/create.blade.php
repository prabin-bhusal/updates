...
<div class="flex justify-between items-center bg-white my-3 p-5 mb-4">
    <h2 class="text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-3xl dark:text-white">
        Resource File</h2>
    <a href="{{ route('admin.download.index') }}" class="text-blue-600 hover:text-yellow-800 hover:cursor-pointer">Back</a>
</div>
<div>
    <div class="py-12">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        <div class="">
                            ...
                            <form method="post" action="{{ route('admin.download.store') }}" enctype="multipart/form-data" class="max-w-md mx-auto">
                                @csrf
                                @method('post')
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    <label for="download_file" name="file" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        File</label>
